...
parser.add_argument('--exclude_nopass', action='store_true', default=False, help='If flag is present, use pass filter to filter out variants that do not PASS. If flag is absent, ignore PASS filter.')
parser.add_argument('--exclude_pass', action='store_true', default=False, help='If flag is present, use pass filter to filter out variants that PASS. If flag is absent, ignore PASS filter.')
